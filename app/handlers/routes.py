...
def configure_routes(app):
    ...
    def get_answers():
        ...
        if (answeryes == "1" and answerno == "0") or (answeryes == "0"
            ...
            n_yes += int(answeryes)
            n_no += int(answerno)
            return f'<img src="static/logo.jpg"><br>Merci d\'avoir participé à ce sondage. Resultats: reponses:{n_rep} oui:{n_yes} non:{n_no}'
        else:
            return '<img src="static/logo.jpg"><br>Désolé, il y a eu un soucis avec votre requete.'
